...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Credit Note</p>

    <div class="container mt-2" >
        <div class="row">  
        <!-- Add search options-------------------------------------------@tilesh -->          
        <form method="post" action="{{url('cn_search')}}" enctype='multipart/form-data' class="form-group">
                  @csrf
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('creditNote.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputState">Credit Note :</label>
                                    <select id="Service_Acc" name="Service_Acc" class="form-control"  >
                                        <option selected value="Credit Note">Credit Note</option>
                                    </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <table id="main-table" class="main-table" style="background-color:#10ac84;border:1px solid white;">
                                ...
                                <tr>
                                    ...
                                    <td id="totalIGST"></td>
                                    <td><input type="hidden" name="addRound" id="addRoundTxt"></td>
                                </tr>
                                </tfoot>
                            </table>
                            </div>
           ...
           @if($bill_last_id==$last_id)                     
            ...
            @else
                ...
                @endif
                            ...
                            <a class="btn mt-3" href="{{ url('creditNote/') }}/{{$last_id-1}}"  style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a>                             
                            @if($bill_last_id==$last_id)

                            @else
                           
                            <a class="btn mt-3" href="{{ url('creditNote/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('creditNote/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
                            @endif
           ...
           <div>
               ...
               Total Amount : <input type="text" name="" id="netAmountTxt">
               <!-- Round Off : <input type="text" name="addRound" id="addRoundTxt"> -->
           </div>
           @else
           <div>

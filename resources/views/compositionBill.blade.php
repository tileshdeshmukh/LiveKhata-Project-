...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Composition Bill</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('compositionBill-created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                         ...
                         <!------------------------------------->
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="name">Cash Party Name :</label>
           ...
           <div class="col-md-1 mt-3">
            ...
            @else
                ...
                <a class="btn mt-3" href="{{'compositionBillInvoice'}}/{{$last_id}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Show Bills</a>
          
            @endif
                            <a class="btn mt-3" href="{{ url('compositionBill/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('compositionBill/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('compositionBill/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>

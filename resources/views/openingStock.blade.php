...
<body  style="background-color:#d1faf0;">
    ...
    @else
        ...
        @include('adminnav')
    @endif
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Opening Stock</p>

    <div class="container mt-2" >
        <div class="row">
            <!-- -->
            <!-- Add search options-------------------------------------------@tilesh -->
            <form method="post" action="{{url('os_search')}}" enctype='multipart/form-data' class="form-group">
                  @csrf
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('openingstock-created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputState">Opening A/C :</label>
                                    <select id="Service_Acc" name="Service_Acc" class="form-control"  >
                                        <option selected value="Opening Stock">Opening Stock</option>                                                                                                                                                                                                                                                                    
                                    </select>     
                            </div>
                            <div class="form-group col-md-3">
           ...
           <div class="col-md-1 mt-3">
            ...
            @if($bill_last_id==$last_id)
                ...
                <button type="submit" value="saveServiceBill" name="serviceBillData"  class="btn mt-3" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Savem & Print</button>   
            @else
                ...
                <a class="btn mt-3" href="{{'openingStockInvoice'}}/{{$last_id}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Print</a>
          
            @endif
                            <a class="btn mt-3" href="{{ url('openingStock/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('openingStock/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('openingStock/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
           ...
           <p class="mt-4">Rount Off : &nbsp;</p>
           <input type="text" class="mt-4" name="addRound" id="addRoundTxt">
           </form>
...
<section>
  ...
  <div class="modal fade accountTreeAddAccount" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="mt-3">
      <form method="POST" action="{{route('openingStockaccountTree.created')}}">
      @csrf
...
<section>
    ...
    <div class="modal fade productTreeAdd" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="mt-3">
            ...
            <form method="POST" action="{{route('openingStockproductTree.created')}}">

...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Tax Invoice Service</p>
    ...
    <div class="container mt-2" >
        <div class="row">            
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('taxInvoiceService.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
           ...
           @if($bill_last_id==$last_id)                     
            ...
            @else
                ...
                @endif
                            ...
                            <a class="btn mt-3" href="{{ url('taxInvoiceService/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('taxInvoiceService/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
                            @endif

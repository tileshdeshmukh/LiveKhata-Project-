...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Excess Stock</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('excessStock-created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputState">Excess Stock A/c :</label>
           ...
           <div class="col-md-1 mt-3">
            ...
            @else
                ...
                <a class="btn mt-3" href="{{'excessStockInvoice'}}/{{$last_id}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Show Bills</a>
          
            @endif
                            <a class="btn mt-3" href="{{ url('excessStock/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('excessStock/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('excessStock/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
...
<section>
  ...
  <div class="modal fade accountTreeAddAccount" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="mt-3">
      <form method="POST" action="{{route('excessStockaccountTree.created')}}">
      @csrf
...
<section>
    ...
    <div class="modal fade productTreeAdd" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="mt-3">
            ...
            <form method="POST" action="{{route('excessStockproductTree.created')}}">

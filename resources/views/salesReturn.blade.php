...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Sales Return</p>

    <div class="container mt-2" >
        <div class="row">
<!-- Add search options-------------------------------------------@tilesh -->
        <form method="post" action="{{url('sr_search')}}" enctype='multipart/form-data' class="form-group">
                  @csrf
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('salesReturn.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputState">Sales Return :</label>
                                    <select id="Service_Acc" name="Service_Acc" class="form-control"  >
                                        <option selected value="Sales Return">Sales Return</option>
                                    </select>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputState">Sales Return :</label>
           ...
           @if($bill_last_id==$last_id)                     
            ...
            @else
                ...
                @endif
                            ...
                            <a class="btn mt-3" href="{{ url('salesReturn/') }}/{{$last_id-1}}"  style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a>                             
                            @if($bill_last_id==$last_id)

                            @else
                           
                            <a class="btn mt-3" href="{{ url('salesReturn/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('salesReturn/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
                            @endif
               ...
               <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="">Round Up -</label>
                                <input type="text" class="form-control" id="addRoundTxt" name="addRound" placeholder=""  @if( $taxInvoiceServiceFetch) value="{{$taxInvoiceServiceFetch->addRound}}" @else value="" @endif >
                            </div>
                            
                            <div class="form-group col-md-3">
                                <label for="">Net Amount -</label>
                                <input type="text" class="form-control" id="netAmountTxt" name="lastNetAmt" placeholder=""  @if( $taxInvoiceServiceFetch) value="{{$taxInvoiceServiceFetch->lastNetAmt}}" @else value="" @endif >
                            </div>
                        </div>
                    </div>
                </div>

...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Payments</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="POST" action="{{route('payments.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-5">
                                <label for="inputState">Cash/Bank :</label>
                            ...
                            <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="cheque_no" name="cheque_no" placeholder="Cheque No"  @if( $serviceBillFetch) value="{{$serviceBillFetch->cheque_no}}" @else value="" @endif required>
                            </div>
                        </div>
                         <!------------------------------------->
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="bill_narration" name="bill_narration" placeholder="Narration"  @if( $serviceBillFetch) value="{{$serviceBillFetch->bill_narration}}" @else value="" @endif required>
                                    </div>

                                    <!-- <div class="form-group col-md-3">   
                                        <label for="name">Paid To :</label>
                                        <input type="text" class="form-control" id="paidTo" name="paidTo" placeholder="Paid To"  @if( $serviceBillFetch) value="{{$serviceBillFetch->paidTo}}" @else value="" @endif required>
                                    </div> -->
                                   
                                    <div class="form-group col-md-2">                                        
                                        <input type="hidden" class="form-control" id="totalTxt" name="total" placeholder=""  >
                                    </div>
                            ...
                            <div class="col-md-12 mt-2  " style="height:285px;overflow: scroll;" >                           
                                <table id="sum_table" class="text-white text-center" style="background-color:#10ac84;border:1px solid white;">                            
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>
                                            <input type="text" value="{{$serv->amount}}"  class=" txtBoxServiceBill AMOUNT" onchange="calTotal({{$i}})"  id="amount{{$i}}"  name="amount[]" style="height:23px;width:250px;" >                                        
                                        </td>                                                                                                                                
                                        <td>                                            
                                            <input type="text" value="{{$serv->remarks}}"  class="txtBoxServiceBill calculation" id="remarks{{$i}}" name="remarks[]"  style="height:23px;width:440px;" >                                            
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtBoxServiceBill AMOUNT" id="amount{{$i}}" onchange="calTotal({{$i}})"  name="amount[]" style="height:23px;width:250px;">                                        
                                        </td>                                                                                         
                                        <td>                                            
                                            <input type="text"  class="txtBoxServiceBill calculation" id="remarks{{$i}}" name="remarks[]"  style="height:23px;width:440px;" value="no">                                            
                                        </td>
<!--                                        
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm"  onclick="clearText({{$i}})" style="height:23px;width:30px;">X</button>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>
                                            <input type="text" step="any"  class="txtBoxServiceBill calculation" id="remarks{{$i}}" name="remarks[]"  style="height:23px;width:440px;" value="no">                                            
                                        </td>
           ...
           <div class="col-md-1 mt-3">
            ...
            @endif
                            <a class="btn mt-3" href="{{ url('payments/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('payments/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('payments/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
        ...
        $(document).ready(function () {
              ...
              function calTotal(i) {
                ...
                $('.AMOUNT').each(function (index, value) {
                    receiptTotal.push(parseFloat($(this).val()));
                });
                var total = 0;
                arr = receiptTotal.filter(function (e) { return e });
                console.log("Filter Table " + arr);
                for (var i in arr) {
                    total += receiptTotal[i];
                }

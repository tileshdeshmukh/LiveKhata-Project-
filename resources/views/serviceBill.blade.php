...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Service Bill</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="POST" action="{{route('serviceBill.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <fieldset>                                    
                                    ...
                                    <input type="text" class="form-control" onchange="resultDueDate()" id="dueDate" name="dueDate" @if( $serviceBillFetch) value="{{$serviceBillFetch->dueDate}}" @else value="" @endif required>                                   
                                </fieldset>
                            </div>

                            <div class="form-group col-md-3">
                                    <label for="inputState">Service A/C :</label>
                                    <select id="Service_Acc" name="Service_Acc" class="form-control" required>
                         ...
                         <!------------------------------------->
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input list="partyAccount" class="form-control partyAccount" onchange="serviceBill_party()" name="customer_name"  type="text"  @if( $serviceBillFetch) value="{{$serviceBillFetch->customer_name}}" @else value="" @endif required>                                                                                
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="serviceBill_mobile"  name="mobile" placeholder="Mobile"   @if( $serviceBillFetch) value="{{$serviceBillFetch->mobile}}" @else value="" @endif required>
                                    </div>
                            ...
                            <div class="col-md-12 mt-2  " style="height:285px;overflow: scroll;" >                           
                                <table id="sum_table" class="text-white text-center" style="background-color:#10ac84;border:1px solid white;">                            
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>                                            
                                            <input type="text" step="any" value="{{$serv->rate}}" class="txtBoxServiceBill calculation" id="MRP{{$i}}" oninput="resultGross({{$i}})" onchange="calTotal();"  name="MRP[]"  style="height:23px;width:160px;">                                        
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="txtBoxServiceBill calculation" id="MRP{{$i}}" oninput="resultGross({{$i}})" onchange="calTotal();"  name="MRP[]"  style="height:23px;width:160px;" >                                        
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>
                                            <input list="item" id="item{{$i}}" value="" class="itemList" onchange="itemName({{$i}})"  name="Item[]"  type="text" style="height:23px;width:220px;">                                    
                                            <datalist id="item">
                                                @foreach ($product1 as $ServiceBillProduct)
                                                    <option value="{{$ServiceBillProduct->itemname}}" data-id="{{$ServiceBillProduct->id}}" data-rate="{{$ServiceBillProduct->Selling_Rate}}">{{$ServiceBillProduct->itemname}}</option>                    
                                                @endforeach
                                            </datalist>
                                        </td>                                                                       
                                        ...
                                        <td>
                                            <input type="number" step="any"  class="txtBoxServiceBill calculation QTY" id="Quantity{{$i}}" oninput="resultQuantity({{$i}})"   onchange="calculateQuantity();calculateTotal()"  name="Quantity[]"  style="height:23px;width:160px;">                                            
                                        </td>
                                        <td>                                            
                                            <input type="number" step="any" class="txtBoxServiceBill calculation" id="MRP{{$i}}" oninput="resultGross({{$i}})" onchange="calTotal();"  name="MRP[]"  style="height:23px;width:160px;" >                                        
                                            <input type="hidden" step="any" value="" class="txtBoxServiceBill calculation" id="itemId{{$i}}" name="itemId[]"  style="height:23px;width:160px;">                                        
           ...
           <div class="col-md-1 mt-3">
            ...
            @endif
                            <a class="btn mt-3" href="{{ url('serviceBill/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('serviceBill/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('serviceBill/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>

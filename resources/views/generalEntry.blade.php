...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">General Entry</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="POST" action="{{route('generalEntry.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="Voucher_no" value="{{$last_id}}"  name="Voucher_no" required>                                   
                            </div>

                            <div class="form-group col-md-4">
                                <fieldset>
                                    <label for="datepicker1">Date :</label>
                                    <input type="text" class="form-control" id="billCreatedDate" name="billCreatedDate" @if( $serviceBillFetch) value="{{$serviceBillFetch->billCreatedDate}}" @else value="" @endif required>                                   
                                </fieldset>
                            </div>  
                         ...
                         <!------------------------------------->
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <input type="hidden" class="form-control" id="totalTxt" name="debitTotal" placeholder=""  >
                                    </div>
                                    <div class="form-group col-md-2">
                                        <input type="hidden" class="form-control" id="totalTxt1" name="creditTotal" placeholder=""  >
                                    </div>
                            ...
                            <div class="col-md-12 mt-2  " style="height:285px;overflow: scroll;" >                           
                                <table id="sum_table" class="text-white text-center" style="background-color:#10ac84;border:1px solid white;">                            
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>
                                            <input list="item" id="account_name{{$i}}" value="{{$serv->account_name}}" class="itemList" onchange="itemName({{$i}})" name="account_name[]"  type="text" style="height:23px;width:280px;">
                                            <datalist id="item">
                                                @foreach ($account as $Accounts)
                                                    <option value="{{$Accounts->name}}" >{{$Accounts->name}}</option>
                                                @endforeach
                                            </datalist>
                                        </td>
                                        <td>
                                            <input type="text"  class=" txtBoxServiceBill DEBIT" id="debit{{$i}}" onblur="calTotalDebit(this,{{$i}})"  name="debit[]" style="height:23px;width:200px;" @if( $serv->debit == "0" ) value="00" @else value="{{$serv->debit}}" @endif>                                        
                                        </td>
                                        <td>
                                            <input type="text" class=" txtBoxServiceBill CREDIT" id="credit{{$i}}" onblur="calTotalCredit(this{{$i}})" name="credit[]" style="height:23px;width:200px;" @if( $serv->credit == "0" ) value="00" @else value="{{$serv->credit}}" @endif>                                        
                                        </td>
                                        <td>
                                            <input type="text" value="{{$serv->DueDate}}" step="any"  class="txtBoxServiceBill" id="DueDate{{$i}}" name="DueDate[]"  style="height:23px;width:290px;">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input list="item" id="account_name{{$i}}" value="" class="itemList"  name="account_name[]"  type="text" style="height:23px;width:280px;" >                                    
                                            <datalist id="item">                                
                                                @foreach ($account as $Accounts)
                                                    <option value="{{$Accounts->name}}" >{{$Accounts->name}}</option>
                                                @endforeach
                                        ...
                                        <td>
                                            <input type="text" class=" txtBoxServiceBill DEBIT" id="debit{{$i}}" onblur="calTotalDebit(this,{{$i}})"  name="debit[]" style="height:23px;width:200px;" >                                        
                                        </td>
                                        <td>
                                            <input type="text" class=" txtBoxServiceBill CREDIT" id="credit{{$i}}" onblur="calTotalCredit(this,{{$i}})" name="credit[]" style="height:23px;width:200px;" >                                        
                                        </td>
                                        <td>
                                            <input type="text" step="any"  class="txtBoxServiceBill" id="DueDate{{$i}}" name="DueDate[]"  style="height:23px;width:290px;">
                                        </td>
<!--                                        
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm"  onclick="clearText({{$i}})" style="height:23px;width:30px;">X</button>
           ...
           <div class="col-md-1 mt-3">
            ...
            @if($bill_last_id==$last_id)
                ...
                <button type="submit" value="saveServiceBill" name="serviceBillData"   class="btn mt-3" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Save</button>   
            @else
                ...
                <!-- <a class="btn mt-3" href="{{'serviceBillInvoice'}}/{{$last_id}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Show Bills</a> -->
          
            @endif
                            <a class="btn mt-3" href="{{ url('generalEntry/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('generalEntry/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('generalEntry/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
           ...
           <div class="row mt-2">
               ...
               <h6 id="quantityCount1"></h6>
                
            </div>
            @else
            <div class="row mt-2">

                <h6 id="quantityCountAfter">Total = {{$serviceBillFetch->total}}</h6>
                <h6 id="quantityCountAfter1">Total = {{$serviceBillFetch->total}}</h6>
            </div>
            @endif  
...
<section>
  ...
  <div class="modal fade accountTreeAddAccount" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      ...
      <div class="mt-3">
      <form method="POST" action="{{route('serviceBillaccTree1.created')}}">
      @csrf
          <div class="form-row">
...
<section>
    ...
    <div class="modal fade productTreeAdd" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="mt-3">
            ...
            <form method="POST" action="{{route('serviceBillproTree1.created')}}">
        ...
        $(document).ready(function () {
              ...
              function calTotalDebit(v,i) {                 
                ...
                function emptyValue() {
                     ...
                     totalDebit = [];
                        ...
                        $('.DEBIT').each(function (index, value) {
                            totalDebit.push(parseFloat($(this).val()));
                        });
                        var total = 0;
                        arr = totalDebit.filter(function (e) { return e });
                        console.log("Filter Table " + arr);
                        for (var i in arr) {
                            var total = arr.reduce((a, b) => a + b);
                        }

                        $("#quantityCount").html("Total = " + total);
                        $("#totalTxt").val(total);
                ...
                function fillValue() {
                    ...
                    console.log("Filter Table F " + arr);

                    for (var i in arr) {
                                                
                        console.log(i + "->" + totalDebit[i]);
              ...
              function calTotalCredit(v,i) {
                ...
                function emptyValue() {
                    ...
                    $('.CREDIT').each(function (index, value) {
                        totalCredit.push(parseFloat($(this).val()));
                    });
                    var total = 0;
                    arr = totalCredit.filter(function (e) { return e });
                    console.log("Filter Table " + arr);
                    for (var i in arr) {
                         var total = arr.reduce((a, b) => a + b);
                    ...
                    $("#quantityCount1").html("Total = " + total);
                    $("#totalTxt1").val(total);
    ...
    @else
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#quantityCountAfter").html("Total = " + total);
                $("#totalTxt").val(total); 
                ...
                var total1 = 0;
                arr1 = totalCredit.filter(function (e) { return e });
                // console.log("Filter Table " + arr);
                for (var i in arr1) {
                ...
                $("#quantityCountAfter1").html("Total = " + total1);
                $("#totalTxt1").val(total1);                                                        
                                
            });


              function calTotalDebit(i) {
                totalDebit = [];
            ...
            function calTotalCredit(i) {
                ...
                $("#quantityCountAfter1").html("Total = " + total);
                $("#totalTxt1").val(total);

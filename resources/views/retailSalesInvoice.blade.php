...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Retail Sales Invoice</p>
    ...
    <form method="post" action="{{url('rsi_search')}}" enctype='multipart/form-data' class="form-group">
                @csrf
    ...
    <!-- ---------------------------------------------- -->
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="post" action="{{route('retailSalesInvoice.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="inputState">Counter Sales :</label>
                                    <select id="Service_Acc" name="Service_Acc" class="form-control"  >
                                        <option selected value="Counter Sales">Counter Sales</option>
                                    </select>
                            </div>
             ...
             <!-- Add Round Off - ---------------------------------------------- @tilesh -->
              <input step="any" class="ml-1" type="hidden" id="addRoundTxt" name="addRound" @if( $taxInvoiceServiceFetch) value="{{$taxInvoiceServiceFetch->addRound}}" @else value="" @endif>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td >                                  
                                                                        ...
                                                                        <datalist id="item">
                                                                            ...
                                                                            <option value="{{$taxInvoiceProduct->itemname}}" data-id="{{$taxInvoiceProduct->id}}" data-tax="{{$taxInvoiceProduct->Taxes}}" data-incl="{{$taxInvoiceProduct->INCL}}" data-rate="{{$taxInvoiceProduct->Selling_Rate}}">{{$taxInvoiceProduct->itemname}}</option>                    
                                                                            @endforeach
                                                                        </datalist>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                    <input type="text" step="any"  value="{{$serv->incl_rate}}"  class="txtBoxServiceBill calculation " id="incl_rate_price{{$i}}" oninput="({{$i}})"   onchange="calculateInclRate({{$i}});resultGross({{$i}})"  name="incl_rate[]"  style="height:23px;width:160px;">                                            
                                                                        <input type="hidden" step="any"  value=""  class="txtBoxServiceBill calculation " id="incl_rate{{$i}}"  style="height:23px;width:160px;">                                            
                                                                        <!-- <input type="text" step="any"  value="{{$serv->incl_rate}}"  class="txtBoxServiceBill calculation " id="incl_rate{{$i}}" name="incl_rate[]"  style="height:23px;width:160px;">                                             -->
                                                                    </td>
                                    ...
                                    @endforeach
                                                            @for($i;$i<=100;$i++)
                                                                <tr>                                    
                                                                    ...
                                                                    <td>
                                                                    <input type="text" step="any"  value=""  class="txtBoxServiceBill calculation " id="incl_rate_price{{$i}}" oninput="({{$i}})"   onchange="calculateInclRate({{$i}});resultGross({{$i}})"  name="incl_rate[]"  style="height:23px;width:160px;">                                            
                                                                        <input type="hidden" step="any"  value=""  class="txtBoxServiceBill calculation " id="incl_rate{{$i}}"  style="height:23px;width:160px;">                                            
                                                                        <!-- <input type="text" step="any"  value=""  class="txtBoxServiceBill calculation " id="incl_rate{{$i}}" oninput="({{$i}})"   onchange="({{$i}});({{$i}})"  name="incl_rate[]"  style="height:23px;width:160px;">                                             -->
                                                                    </td>
                                                                    <td>                                            
           ...
           @if($bill_last_id==$last_id)                     
            ...
            @else
                ...
                @endif
                            ...
                            <a class="btn mt-3" href="{{ url('retailSalesInvoice/') }}/{{$last_id-1}}"  style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a>                             
                            @if($bill_last_id==$last_id)

                            @else
                           
                            <a class="btn mt-3" href="{{ url('retailSalesInvoice/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('retailSalesInvoice/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>
           ...
           <div>
               ...
               <h6 id="addRound" class="mt-2"></h6>
               <input type="hidden" name="" id="netAmountTxt">
               <input type="hidden" name="" id="addRoundTxt">
           </div>
           @else
           <div>
               <h6 class="mt-2" id="netAmt">Round Off - {{$taxInvoiceServiceFetch->totalRoundoffAmount}}</h6>
               <h6 id="addRound" class="mt-2">Add Round - {{ $taxInvoiceServiceFetch->addRound }}</h6>
               <input type="hidden" name="" id="netAmountTxt">
               <input type="hidden" name="" id="addRoundTxt">
...
<div class="form-row">
    ...
    @if($bill_last_id==$last_id)
        <script src="js/retailSalesInvoice.js"></script>
    @else
        <script src="../js/updateretailSalesInvoice.js"></script>
    @endif

...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Petty Cash</p>
    ...
    <div class="container mt-2" >
        <div class="row">
           ...
           <div class="col-lg-11">
              <div class="row">
                <div class="col-md-12">
            <form method="POST" action="{{route('pettyCash.created')}}" enctype='multipart/form-data' > 
                @csrf
                    <div class="form-row">
...
<!--                                        
           ...
           <div class="col-md-1 mt-3">
            ...
            @endif
                            <a class="btn mt-3" href="{{ url('pettyCash/') }}/{{$last_id-1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Preview</a> 
                            @if($bill_last_id==$last_id)

                            @else
                            <a class="btn mt-3" href="{{ url('pettyCash/') }}/{{$last_id+1}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Next</a>
                            <a class="btn mt-3" href="{{ url('pettyCash/') }}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Last Record</a>

...
<body  style="background-color:#d1faf0;">
    @include('adminnav')
    <p class="text-center text-white"  style="background-color:#10ac84;font-size:22px;">Estemate</p>
    ...
    <div class="container mt-2" >
        <div class="row">
                                ...
                                <div class="form-row">
                                   ...
                                   <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="hidden" class="form-control" id="totalCounttxt" name="totalCounttxt" placeholder="">
                                    </div>
                                   </div>
                            ...
                            <div class="col-md-12 mt-2  " style="height:285px;overflow: scroll;" >                           
                                <table id="sum_table" class="text-white text-center" style="background-color:#10ac84;border:1px solid white;">                            
                                    ...
                                    <tr>                                    
                                        ...
                                        <td >                                  
                                            ...
                                            <datalist id="item">                                
                                                @foreach ($product as $ServiceBillProduct) 
                                                    <option value="{{$ServiceBillProduct->itemname}}" data-id="{{$ServiceBillProduct->Selling_Rate}}">{{$ServiceBillProduct->itemname}}</option>                    
                                                @endforeach
                                            </datalist>
                                        </td>                                                                       
                                        <td>
                                        ...
                                        <td>                                            
                                            <input type="number" value="{{$serv->quntity}}"  class="txtBoxServiceBill calculation" id="Quantity{{$i}}" oninput="resultQuantity({{$i}})"   onchange="calculateQuantity({{$i}});calculateTotal({{$i}})"  name="Quantity[]"  style="height:23px;width:160px;">                                            
                                        </td>
                                        <td>                                            
                                        ...
                                        <td>
                                            <input type="text" step="any" value="{{$serv->gross}}" class="txtBoxServiceBill calculation" id="Gross{{$i}}" oninput="resultMrp({{$i}})"  name="Gross[]"  style="height:23px;width:210px;" >
                                        </td>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>                                            
                                            <input type="number" value=""  class="txtBoxServiceBill calculation" id="Quantity{{$i}}" oninput="resultQuantity({{$i}})"   onchange="calculateQuantity({{$i}});calculateTotal({{$i}})"  name="Quantity[]"  style="height:23px;width:160px;">                                            
                                        </td>
                                        <td>                                            
                                        ...
                                        <td>
                                            <input type="text" step="any" class="txtBoxServiceBill calculation" id="Gross{{$i}}" oninput="resultMrp({{$i}})"  name="Gross[]"  style="height:23px;width:210px;" >
                                        </td>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td>                                            
                                            <input type="number" value="" class="txtBoxServiceBill calculation" id="MRP{{$i}}" oninput="resultGross({{$i}})" onchange="calTotal({{$i}});"  name="MRP[]"  style="height:23px;width:160px;">                                        
                                        </td>
                                        <td>
                                            <input type="number" class="txtBoxServiceBill calculation" id="Gross{{$i}}" oninput="resultMrp({{$i}})"  name="Gross[]"  style="height:23px;width:210px;" >
                                        </td>
           ...
           <div class="col-md-1 mt-3">
            ...
            @endif
                            <a class="btn mt-3" href="{{'taxInvoiceServicePDF'}}/{{$last_id}}" style="background-color:#10ac84;color:white;width:125px;border:2px solid white" >Show Bills</a>
